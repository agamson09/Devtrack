                ...
                {tenants.map((t) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={switching}
                      className={`w-full flex items-center gap-3 px-2 py-2 rounded-lg text-sm transition-colors text-left relative ${
                        isActive 
                          ? (isLight ? 'bg-indigo-50' : 'bg-gray-700/50')
                          : (isLight ? 'hover:bg-gray-50' : 'hover:bg-gray-700/30')
                      }`}
                    >
                      <div className={`w-8 h-8 rounded-md flex items-center justify-center flex-shrink-0 font-medium ${
                        isActive 
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`font-medium truncate ${isActive ? (isLight ? 'text-indigo-900' : 'text-white') : (isLight ? 'text-gray-700' : 'text-gray-300')}`}>
                          {t.name}
                        </p>
                      </div>
                      {isActive && (
